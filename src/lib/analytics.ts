...
export function captureFirstAttribution(): FirstAttribution {
  ...
  const attribution: FirstAttribution = {
    utmSource: cleanAttributionValue(params.get('utm_source')) ?? shortLink?.utmSource,
    utmCampaign: cleanAttributionValue(params.get('utm_campaign')) ?? shortLink?.utmCampaign,
